...
Feature: Create a Web Behavior Segment of Viewing a Page
  As a Business User, I should be able to create a Web Behavior to view a Page in a Segment
  ...
  Scenario: Create a Web Behavior Segment Viewing a Page
      ...
      When I create a criteria with the following Web Behavior conditions:
        | Viewed Page | has | innovate visionary platforms | at least | 8 | ever |
      ...
      Then I should see a "Segment" named "CreateDynamicWebBehaviorSegment - ${Random.1}" with 3 items