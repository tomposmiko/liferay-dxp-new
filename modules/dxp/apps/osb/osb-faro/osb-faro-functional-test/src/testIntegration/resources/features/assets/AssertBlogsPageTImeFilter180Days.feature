...
Feature: Assert 180 day time filter in Blogs
	As an Business User, I should be able to change the time filter to 180 days in the Blogs page
	...
	Scenario: Change time filter in Blogs page to 180 days
