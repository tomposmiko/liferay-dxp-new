...
Feature: Create a Web Behavior Segment of Viewing Document & Media in a Topic
    As a Business User, I should be able to create a Web Behavior to view Document & Media in a segment
    ...
    Scenario: Create a Web Behavior Segment Viewing a Document & Media
        ...
        When I create a criteria with the following Web Behavior conditions:
          | Viewed Document & Media | has | mesh distributed users | at least | 2 | ever |
