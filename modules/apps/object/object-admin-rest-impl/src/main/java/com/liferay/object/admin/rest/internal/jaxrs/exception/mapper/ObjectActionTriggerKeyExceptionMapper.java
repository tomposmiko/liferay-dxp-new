...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Object.Admin.REST.ObjectActionTriggerKeyExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class ObjectActionTriggerKeyExceptionMapper
	extends BaseExceptionMapper<ObjectActionTriggerKeyException> {
