...
public abstract class BaseSearchResponseResourceImpl
	 ...
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/portal-search-rest/v1.0/search' -d $'{"facets": ___, "searchContextAttributes": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	...
	public SearchResponse postSearch(
			...
			@javax.ws.rs.QueryParam("basicFacetSelection")
			Boolean basicFacetSelection,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.ws.rs.QueryParam("entryClassNames")
			String[] entryClassNames,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.ws.rs.QueryParam("explain")
			Boolean explain,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.ws.rs.QueryParam("groupIds")
			Long[] groupIds,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.ws.rs.QueryParam("includeAssetSearchSummary")
			Boolean includeAssetSearchSummary,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.ws.rs.QueryParam("includeAssetTitle")
			Boolean includeAssetTitle,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.ws.rs.QueryParam("includeRequest")
			Boolean includeRequest,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.ws.rs.QueryParam("includeResponse")
			Boolean includeResponse,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.ws.rs.QueryParam("keywords")
			String keywords,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.ws.rs.QueryParam("resultFields")
			String[] resultFields,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.ws.rs.QueryParam("scopeGroupId")
			Long scopeGroupId,
