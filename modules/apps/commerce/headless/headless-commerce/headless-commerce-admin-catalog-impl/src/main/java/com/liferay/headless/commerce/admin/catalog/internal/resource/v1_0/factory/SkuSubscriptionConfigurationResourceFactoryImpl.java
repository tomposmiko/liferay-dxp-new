 ...
 */
@Component(
	property = "resource.locator.key=/headless-commerce-admin-catalog/v1.0/SkuSubscriptionConfiguration",
	service = SkuSubscriptionConfigurationResource.Factory.class
)
@Generated("")
public class SkuSubscriptionConfigurationResourceFactoryImpl
	implements SkuSubscriptionConfigurationResource.Factory {

	@Override
	public SkuSubscriptionConfigurationResource.Builder create() {
		return new SkuSubscriptionConfigurationResource.Builder() {
			...
			@Override
			public SkuSubscriptionConfigurationResource.Builder
			...
			@Override
			public SkuSubscriptionConfigurationResource.Builder preferredLocale(
			...
			@Override
			public SkuSubscriptionConfigurationResource.Builder user(
				User user) {
	...
	private static Function
		...
		Class<?> proxyClass = ProxyUtil.getProxyClass(
			SkuSubscriptionConfigurationResource.class.getClassLoader(),
			SkuSubscriptionConfigurationResource.class);

		try {
			Constructor<SkuSubscriptionConfigurationResource> constructor =
				(Constructor<SkuSubscriptionConfigurationResource>)
