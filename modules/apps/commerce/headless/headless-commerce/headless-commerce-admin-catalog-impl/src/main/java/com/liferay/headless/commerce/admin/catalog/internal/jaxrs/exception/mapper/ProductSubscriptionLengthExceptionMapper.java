...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.ProductSubscriptionLengthExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class ProductSubscriptionLengthExceptionMapper
	...
	protected Problem getProblem(
		...
		return new Problem(cpDefinitionSubscriptionLengthException);
	}
