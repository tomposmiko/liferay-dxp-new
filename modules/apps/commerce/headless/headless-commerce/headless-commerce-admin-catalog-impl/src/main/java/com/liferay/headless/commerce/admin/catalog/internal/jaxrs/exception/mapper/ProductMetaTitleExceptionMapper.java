...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.ProductMetaTitleExceptionMapper"
	},
	service = ExceptionMapper.class
)
@Provider
public class ProductMetaTitleExceptionMapper
	...
	protected Problem getProblem(
		...
		return new Problem(cpDefinitionMetaTitleException);
	}
