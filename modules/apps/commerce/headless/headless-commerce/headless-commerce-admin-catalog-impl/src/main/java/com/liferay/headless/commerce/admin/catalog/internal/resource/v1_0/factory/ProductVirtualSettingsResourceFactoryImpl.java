 ...
 */
@Component(
	property = "resource.locator.key=/headless-commerce-admin-catalog/v1.0/ProductVirtualSettings",
	service = ProductVirtualSettingsResource.Factory.class
)
@Generated("")
public class ProductVirtualSettingsResourceFactoryImpl
	implements ProductVirtualSettingsResource.Factory {

	@Override
	public ProductVirtualSettingsResource.Builder create() {
		return new ProductVirtualSettingsResource.Builder() {
			...
			@Override
			public ProductVirtualSettingsResource.Builder checkPermissions(
			...
			@Override
			public ProductVirtualSettingsResource.Builder httpServletRequest(
			...
			@Override
			public ProductVirtualSettingsResource.Builder httpServletResponse(
			...
			@Override
			public ProductVirtualSettingsResource.Builder preferredLocale(
			...
			@Override
			public ProductVirtualSettingsResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, ProductVirtualSettingsResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			ProductVirtualSettingsResource.class.getClassLoader(),
			ProductVirtualSettingsResource.class);

		try {
			Constructor<ProductVirtualSettingsResource> constructor =
				(Constructor<ProductVirtualSettingsResource>)
