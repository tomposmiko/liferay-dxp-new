...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.ProductIgnoreSKUCombinationsExceptionMapper"
	},
	service = ExceptionMapper.class
)
@Provider
public class ProductIgnoreSKUCombinationsExceptionMapper
	...
	protected Problem getProblem(
		...
		return new Problem(cpDefinitionIgnoreSKUCombinationsException);
	}
