...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.ProductSpecificationTitleExceptionMapper"
	},
	service = ExceptionMapper.class
)
@Provider
public class ProductSpecificationTitleExceptionMapper
	...
	protected Problem getProblem(
		...
		return new Problem(cpSpecificationOptionTitleException);
	}
