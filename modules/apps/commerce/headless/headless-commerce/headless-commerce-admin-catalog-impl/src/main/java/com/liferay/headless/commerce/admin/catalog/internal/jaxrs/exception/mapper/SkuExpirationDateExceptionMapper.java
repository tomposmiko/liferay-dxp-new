...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.SkuExpirationDateExceptionMapper"
	},
	service = ExceptionMapper.class
)
@Provider
public class SkuExpirationDateExceptionMapper
	...
	protected Problem getProblem(
		...
		return new Problem(cpInstanceExpirationDateException);
	}
