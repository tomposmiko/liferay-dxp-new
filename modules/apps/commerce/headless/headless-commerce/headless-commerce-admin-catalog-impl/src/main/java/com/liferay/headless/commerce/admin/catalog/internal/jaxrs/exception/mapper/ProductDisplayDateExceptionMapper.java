...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.ProductDisplayDateExceptionMapper"
	},
	service = ExceptionMapper.class
)
@Provider
public class ProductDisplayDateExceptionMapper
	...
	protected Problem getProblem(
		...
		return new Problem(cpDefinitionDisplayDateException);
	}
