...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.ProductExpirationDateExceptionMapper"
	},
	service = ExceptionMapper.class
)
@Provider
public class ProductExpirationDateExceptionMapper
	...
	protected Problem getProblem(
		...
		return new Problem(cpDefinitionExpirationDateException);
	}
