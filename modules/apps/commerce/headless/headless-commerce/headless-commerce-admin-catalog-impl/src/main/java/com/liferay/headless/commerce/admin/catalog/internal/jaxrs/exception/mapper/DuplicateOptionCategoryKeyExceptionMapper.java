...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.DuplicateOptionCategoryKeyExceptionMapper"
	},
	service = ExceptionMapper.class
)
@Provider
public class DuplicateOptionCategoryKeyExceptionMapper
