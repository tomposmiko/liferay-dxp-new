...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.ProductMetaDescriptionExceptionMapper"
	},
	service = ExceptionMapper.class
)
@Provider
public class ProductMetaDescriptionExceptionMapper
	...
	protected Problem getProblem(
		...
		return new Problem(cpDefinitionMetaDescriptionException);
	}
