...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.AttachmentSizeExceptionMapper"
	},
	service = ExceptionMapper.class
)
@Provider
public class AttachmentSizeExceptionMapper
	...
	protected Problem getProblem(
		...
		return new Problem(cpAttachmentFileEntrySizeException);
	}
