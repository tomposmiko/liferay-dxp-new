...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.ProductProductTypeExceptionMapper"
	},
	service = ExceptionMapper.class
)
@Provider
public class ProductProductTypeExceptionMapper
	...
	protected Problem getProblem(
		...
		return new Problem(cpDefinitionProductTypeNameException);
	}
