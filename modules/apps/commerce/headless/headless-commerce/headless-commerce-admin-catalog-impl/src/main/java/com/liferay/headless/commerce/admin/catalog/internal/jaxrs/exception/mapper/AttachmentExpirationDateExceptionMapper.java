...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.AttachmentExpirationDateExceptionMapper"
	},
	service = ExceptionMapper.class
)
@Provider
public class AttachmentExpirationDateExceptionMapper
	...
	protected Problem getProblem(
		...
		return new Problem(cpAttachmentFileEntryExpirationDateException);
	}
